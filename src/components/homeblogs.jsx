...
const Blogs = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-8">
            {/* <h1 className="text-5xl font-bold mb-6 text-center text-gray-800">Blog Posts</h1> */}
            <h1 className="text-5xl font-bold mb-10 text-center text-gray-700">Trending now</h1>
